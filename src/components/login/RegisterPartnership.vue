                ...
                <div class="forms row justify-content-md-center text-left">
                    <div class="col-md-10 tempatUsaha mb-4 mt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" id="inputTempat" placeholder="Nama Tempat Print/Fotocopy">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputKota" class="col-sm-3 font-weight-bold col-form-label col-form-label-sm">Kota</label>
                            <div class="col-sm-9">
                                <select class="custom-select custom-select-sm" id="inputKota">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" id="inputAlamat" placeholder="Alamat Tempat">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputJenis" class="col-sm-3 font-weight-bold col-form-label col-form-label-sm">Jenis Usaha</label>
                            <div class="col-sm-9">
                                <select class="custom-select custom-select-sm" id="inputJenis">
                                    <option selected>Pilih Jenis Usaha</option>
                                    <option value="1">Percetakan Massal</option>
                    ...
                    <div class="col-md-10 pemilikUsaha">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" id="inputNamaPemilik" placeholder="Nama Pemilik">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputTelp" class="col-sm-3 font-weight-bold col-form-label col-form-label-sm">Telepon</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-sm" id="inputTelp" placeholder="Nomor Telepon">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control form-control-sm" id="inputSandi" placeholder="Masukan Kata Sandi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputUlangSandi" class="col-sm-3 font-weight-bold col-form-label col-form-label-sm">Konfirmasi Sandi</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control form-control-sm" id="inputUlangSandi" placeholder="Konfirmasi Kata Sandi">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 confirm mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <button type="submit" class="btn btn-primary float-right btn-block">Daftar</button>
                            </div>
                        </div>
                    </div>
